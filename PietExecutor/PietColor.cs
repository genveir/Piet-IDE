...
namespace PietExecutor
{
    public class PietColor
    {
        ...
        static PietColor()
        {
            ...
            {
                new PietColor("light red", 0, 0, Color.FromArgb(255, 192, 192)),
                new PietColor("red", 0, 1, Color.FromArgb(255, 0, 0))  ,
                new PietColor("dark red", 0, 2, Color.FromArgb(192, 0, 0))
            }; // red
            Colors[1] = new PietColor[]
            {
                new PietColor("light yellow", 1, 0, Color.FromArgb(255, 255, 192)),
                new PietColor("yellow", 1, 1, Color.FromArgb(255, 255, 0)),
                new PietColor("dark yellow", 1, 2, Color.FromArgb(192, 192, 0))
            }; // yellow
            Colors[2] = new PietColor[]
            {
                new PietColor("light green", 2, 0, Color.FromArgb(192, 255, 192)),
                new PietColor("green", 2, 1, Color.FromArgb(0, 255, 0))  ,
                new PietColor("dark green", 2, 2, Color.FromArgb(0, 192, 0))
            }; // green
            Colors[3] = new PietColor[]
            {
                new PietColor("light cyan", 3, 0, Color.FromArgb(192, 255, 255)),
                new PietColor("cyan", 3, 1, Color.FromArgb(0, 255, 255)),
                new PietColor("dark cyan", 3, 2, Color.FromArgb(0, 192, 192))
            }; // cyan
            Colors[4] = new PietColor[]
            {
                new PietColor("light blue", 4, 0, Color.FromArgb(192, 192, 255)),
                new PietColor("blue", 4, 1, Color.FromArgb(0, 0, 255))  ,
                new PietColor("dark blue", 4, 2, Color.FromArgb(0, 0, 192))
            }; // blue
            Colors[5] = new PietColor[]
            {
                new PietColor("light magenta", 5, 0, Color.FromArgb(255, 192, 255)),
                new PietColor("magenta", 5, 1, Color.FromArgb(255, 0, 255)),
                new PietColor("dark magenta", 5, 2, Color.FromArgb(192, 0, 192))
            };  // magenta
